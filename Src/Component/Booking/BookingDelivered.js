        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
            ...
            <View style={{ marginBottom: 10, paddingHorizontal: 20 }}>
                ...
                <View style={{
                    ...
                    <View>
                        <Text style={{ fontSize: 14 }}>From: C-32, F block, Sector 40, Noida</Text>
                        <Text style={{ fontSize: 14 }}>To: A-56, G block, Sector 110, Greater Noida</Text>
                    </View>
...
export default BookingDelivered;
